    ...
    with app.app_context():
        ...
        blocks_to_create = [
            ...
            # 5. Блок Магазин
            {
                ...
                "content": "Оформляйте замовлення на веб-сайти, ботів та інші цифрові рішення для вашого бізнесу. Оплачуйте зручним способом, у тому числі токенами IT TOKEN, та отримуйте постійні оновлення й підтримку.",
                "content_en": "Order websites, bots and other digital solutions for your business. Pay conveniently, including with IT TOKEN, and receive ongoing updates and support.",
                "content_de": "Bestellen Sie Websites, Bots und andere digitale Lösungen für Ihr Unternehmen. Zahlen Sie bequem, auch mit IT TOKEN, und erhalten Sie fortlaufende Updates und Support.",
                "content_ru": "Заказывайте сайты, ботов и другие цифровые решения для вашего бизнеса. Оплачивайте удобным способом, в том числе токенами IT TOKEN, и получайте постоянные обновления и поддержку.",
                "slug": "shop",
                "order": 5
            },
            # 6. Блок Платежи
